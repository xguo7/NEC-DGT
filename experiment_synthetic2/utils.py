...
def read_data(self):    
      ...
      x=np.load('C:/Users/gxjco/Desktop/multi-attributed-new/dataset/erdos/erdos40_x.npy')[0:500]
      y=np.load('C:/Users/gxjco/Desktop/multi-attributed-new/dataset/erdos/erdos40_y.npy')[0:500]

...
import scipy.misc
import numpy as np
from model_1b import graph2graph
...
parser.add_argument('--No', type=int, default=40, help='The Number of Objects')
parser.add_argument('--Nr', type=int, default=1560, help='The Number of Relations')
...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint40',help='models are saved here')
